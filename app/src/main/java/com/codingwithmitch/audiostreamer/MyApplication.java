...
public class MyApplication extends Application {
    ...
    public void setMediaItems(List<MediaMetadataCompat> mediaItems){
        ...
        for(MediaMetadataCompat item: mediaItems){
            mMediaItems.add(new MediaBrowserCompat.MediaItem(item.getDescription(), MediaBrowserCompat.MediaItem.FLAG_PLAYABLE));
    ...
    public TreeMap<String, MediaMetadataCompat> getmTreeMap() {
        return mTreeMap;
    }
